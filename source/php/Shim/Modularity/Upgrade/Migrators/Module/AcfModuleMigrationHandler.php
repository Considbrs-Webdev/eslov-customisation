...
/**
 * Upstream bool-cast fix for Modularity upgrade (ACF update_field can return int meta ID).
 * Preloaded by ModularityUpgradeRunner before Upgrade::upgrade(); remove when upstream fixes.
 */
